        ...
        <div className="p-3">
          ...
          <div className="grid md:grid-cols-3 md:gap-4">
            <div className="bg-white p-3 rounded-lg mt-3 pl-5">
              <div className="flex items-center gap-1 text-lg font-semibold"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-clock h-5 w-5 text-teal-600" data-lov-id="src/pages/Dashboard.tsx:65:16" data-lov-name="Clock" data-component-path="src/pages/Dashboard.tsx" data-component-line="65" data-component-file="Dashboard.tsx" data-component-name="Clock" data-component-content="%7B%22className%22%3A%22h-5%20w-5%20text-primary%22%7D"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg> <div>Today's Tasks</div></div>
