          ...
          <div className="nav p-2 flex  max-w-3xl w-full justify-between  border-b-sky-800">
            ...
            {authUser ? (
              <div className="profile flex items-center gap-2">
                ...
                <div className=''>
                <i className="fa-solid fa-bars font-bold text-2xl" onClick={()=>{ if (options == true){
                setOptions(false);
